 ...
 */
public class HomeLastUpdateInitialization extends HomeInitialization {

    public HomeLastUpdateInitialization(Callback callback, RecyclerView recyclerView,
    ...
    public void getData(int pageNum) {
        ...
        Call<ResponseMovieList> call = baseApi.getLastUpdate(
        ...
        call.enqueue(new retrofit2.Callback<ResponseMovieList>() {
            ...
            public void onResponse(Call<ResponseMovieList> call, Response<ResponseMovieList> response) {
                List<Movie> lastUpdateList = response.body().getData();
                callback.onGettingSuccess(lastUpdateList, adapter);
            }
