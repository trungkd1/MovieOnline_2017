...
public class HomePopularInitialization extends HomeInitialization {

    public HomePopularInitialization(Callback callback, RecyclerView recyclerView,
    ...
    public void getData(int pageNum) {
        ...
        Call<ResponseMovieList> call = baseApi.getPopular(
        ...
        call.enqueue(new retrofit2.Callback<ResponseMovieList>() {
            ...
            public void onResponse(Call<ResponseMovieList> call, Response<ResponseMovieList> response) {
                List<Movie> popularList = response.body().getData();
                callback.onGettingSuccess(popularList, adapter);
            }
