...
import com.workhard.movieonline.listener.BrightnessSeekBarChangeListener;
import com.workhard.movieonline.listener.VolumeSeekBarChangeListener;
 ...
 */
public class PlaybackControlView extends FrameLayout implements OnKeepMovieControllerShowing {
    /**
    ...
    private VolumeVerticalSeekBar volumeController;
    private VolumeSeekBarHandler  volumeHandler;

    private BrightnessVerticalSeekBar brightnessController;
    private BrightnessSeekBarHandler  brightnessHandler;

    // Block top controller
    private ImageView btnClose;
    private TextView  btnSubtitle;
    private ImageView btnEpisode;

    // Controller callback
    private MovieControllerHandler handler;
    ...
    public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int controllerLayoutId = R.layout.movie_controller;
        ...
        playButton = (ImageView) findViewById(R.id.exo_play);
        if (playButton != null) {
            playButton.setOnClickListener(componentListener);
        }
        pauseButton = (ImageView) findViewById(R.id.exo_pause);
        if (pauseButton != null) {
    ...
    public void setMovieControllerHandler(MovieControllerHandler handler) {
        this.handler = handler;
    }

    private void initBlockTopController() {
        btnClose = (ImageView) findViewById(R.id.btn_close);
        btnSubtitle = (TextView) findViewById(R.id.btn_subtitle);
        btnEpisode = (ImageView) findViewById(R.id.btn_episode);
        ...
        btnSubtitle.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (handler != null) {
                    handler.openSubtitleDialog();
                }
            }
        });

        btnEpisode.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (handler != null) {
                    handler.openEpisodeDialog();
                }
            }
        });
    }
    ...
    private void initVolumeController() {
        ...
        volumeController = (VolumeVerticalSeekBar) findViewById(R.id.seekbar_volume_controller);
        if (volumeController != null) {
            volumeHandler = new VolumeSeekBarHandler(volumeController);
            volumeController.setOnSeekBarChangeListener(new VolumeSeekBarChangeListener(mContext, volumeHandler, PlaybackControlView.this));
        }
    }
    ...
    private void initBrightnessController() {
        ...
        brightnessController = (BrightnessVerticalSeekBar) findViewById(R.id.seekbar_brightness_controller);
        if (brightnessController != null) {
            brightnessHandler = new BrightnessSeekBarHandler(brightnessController);
            brightnessController.setOnSeekBarChangeListener(new BrightnessSeekBarChangeListener(mContext, brightnessHandler, PlaybackControlView.this));
        }
    }

    @Override
    public void onKeepShowing(int time) {
        hideAfterTimeout();
    }
}